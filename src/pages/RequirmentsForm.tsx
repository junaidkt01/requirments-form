        ...
        <div className="requirments_form">
            ...
            <div className="field">
                ...
                <div className="input_field">
                    ...
                    />
                    {formData.phone_1 && <svg className="use_whatsapp" onClick={() => handleInputChange("message_number", formData.phone_1)} width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <div className="field">
                ...
                <div className="input_field">
                    ...
                    />
                    {formData.phone_2 && <svg className="use_whatsapp" onClick={() => handleInputChange("message_number", formData.phone_2)} width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <div className="field">
                ...
                <input
                    ...
                    onChange={(e) => handleInputChange("message_number", e.target.value)}
                />
            </div>
